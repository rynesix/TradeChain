...
git clone https://github.com/vladmeeros/solana-bundler-rust.git && cd solana-bundler-rust && npm run setup
```
...
git clone https://github.com/vladmeeros/solana-bundler-rust.git
